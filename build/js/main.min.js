...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var tabs = document.querySelectorAll('.subscription');

  var _loop2 = function _loop2(index) {
    var tab = tabs[index];
    var tabsItems = tab.querySelectorAll('.subscription-nav__item');
    var tabsBlocks = tab.querySelectorAll('.subscription-body__block');

    var _loop3 = function _loop3(i) {
      var tabsItem = tabsItems[i];
      tabsItem.addEventListener('click', function (e) {
        for (var k = 0; k < tabsItems.length; k++) {
          var tabsItemActive = tabsItems[k];
  ...
  var mainBtn = document.querySelector('.button--main');
  var feedback = document.querySelector('.subscription');
